<?php
function placesRecommendation($codition = '', $question = '') {
  $weather = array("Bogota" => "cold", "Montaria" => "hot", "Medelling" => "miled");
  $ubication = array("Guajira" => "north", "Leticia" => "south", "Santander" => "east", "Antioquia" => "west");
  $tourism = array("Santa Maria" => "sea", "Villavecencio" => "plains", "Riohacha" => "desert", "Quindio" => "valley");
